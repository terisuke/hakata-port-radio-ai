...
|---------|--------|---------|------|--------|-----------|--------|---------|------|------|
| T1-001 | Phase1 | Next.js 15プロジェクト初期化 | - | P0 | ⬜ Not Started | Day1 | Day1 | - | |
| T1-002 | Phase1 | 依存パッケージインストール | - | P0 | ⬜ Not Started | Day1 | Day1 | - | |
| T1-003 | Phase1 | Vercelプロジェクト設定 | - | P0 | ⬜ Not Started | Day1 | Day1 | - | |
| T1-004 | Phase1 | Vercel Postgres設定 | - | P0 | ⬜ Not Started | Day1 | Day1 | - | |
